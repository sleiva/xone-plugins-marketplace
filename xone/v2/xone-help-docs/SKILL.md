...
| Animación Lottie (`.json` / `.lottie` / `.tgs`) en un `IMG` | [topics/02b-xml-prop-tipos.md §5.9.8](topics/02b-xml-prop-tipos.md#598-imagen-img) |
...
| Escanear un documento en papel (`scanDocument`) | [topics/03b-js-ui.md §3.5](topics/03b-js-ui.md#scandocumentparams---escáner-de-documentos-en-papel) |
| OCR de una imagen (`recognizeText`), ROI y líneas con confianza | [topics/03b-js-ui.md §3.5](topics/03b-js-ui.md#recognizetextparams---ocr-de-una-imagen) |

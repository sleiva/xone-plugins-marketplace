# XML/UI — Layouts avanzados, herencia y best practices

Sub-archivo del [Tópico 02 - Guía Completa de XML/UI](02-xml-ui-complete-guide.md). Cubre layouts avanzados (responsive, overlays, sticky headers, FAB), herencia entre colecciones (`inherits`) y composición XML (`<include-layout>`), y las buenas prácticas / anti-patrones críticos de XML.

## Tabla de Contenidos

- [9. Layouts Avanzados](#9-layouts-avanzados)
- [10. Herencia entre Colecciones y Composición XML](#10-herencia-entre-colecciones-y-composicion-xml)
- [11. Best Practices y Anti-patrones](#11-best-practices-y-anti-patrones)
...
9. **Un archivo `.xne` por coleccion**: Salvo `mappings.xne` (ver [Tópico 01 - Estructura](./01-xone-fundamentals.md)).
10. **Comentarios XML explicativos**: Documentar cada sección importante.
11. **Usar clases CSS en lugar de estilos inline**: Para reutilización (ver [Tópico 04](./04-css-styling-guide.md)).
...
10. **Usar CSS web estándar**: XOne tiene su propio CSS propietario. Ver [Tópico 04](./04-css-styling-guide.md).
...
> **Referencia cruzada**: Para más información sobre estructura de proyecto consulta el [Tópico 01 - Estructura del Proyecto](./01-xone-fundamentals.md). Para estilos CSS, consulta el [Tópico 04 - CSS](./04-css-styling-guide.md). Para la API JavaScript, consulta el [Tópico 03 - JavaScript](./03-javascript-api-guide.md). Para crear un proyecto desde cero, consulta el [Tópico 01 - Fundamentos](./01-xone-fundamentals.md).

---

**Anterior:** [02c - Contents, macros, patrones de pantalla](02c-xml-contents-patrones.md) · **Índice:** [02 - Guía XML/UI](02-xml-ui-complete-guide.md)
